...
function abreNovaAba(linkRel){
	if (linkRel != null){
		window.open("#{request.contextPath}/relatorios/" + linkRel, "_blank", "width=screen.availWidth, height=screen.availHeight, dependent=yes, menubar=no, toolbar=no, resizable=yes");
	} else {
		window.open("", "_blank", "width=screen.availWidth, height=screen.availHeight, dependent=yes, menubar=no, toolbar=no, resizable=yes");
	}
}
